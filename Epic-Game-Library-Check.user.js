          ...
          updateEpicOwnedGames = function _updateEpicOwnedGames() {
            ...
            return new Promise(function (resolve, reject) {
              ...
              var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(response) {
                ...
                var result, ordersLength, _response$response$or2, _response$response2, orderedGames, _lastCreatedAt;
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 3:
                        ...
                        return _context2.abrupt("return", updateEpicOwnedGames(loop, i, games, lastCreatedAt));
                          ...
                          return _regeneratorRuntime().wrap(function _callee10$(_context10) {
                            while (1) {
                              switch (_context10.prev = _context10.next) {
                                case 0:
                                  return _context10.abrupt("return", response.response.success === true);
